...
-(QSTodoService *)init
{
    ...
    if (self)
    {
        ...
        MSClient *client = [MSClient clientWithApplicationURLString:@"https://rtinsley-chitter.azure-mobile.net/"
                                                     applicationKey:@"ujRHiuFyoYfUWEzKiamGlCLiohXjes91"];
        
        // Add a Mobile Service filter to enable the busy indicator
        self.client = [client clientWithFilter:self];
        
        // Create an MSTable instance to allow us to work with the TodoItem table
        self.table = [_client tableWithName:@"chitter"];
